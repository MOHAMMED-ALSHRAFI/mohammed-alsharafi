    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#428bca">Dash board</a>
            </div>
...
<?php if ($_SESSION['user_info']) {
    echo "<pre style=\"margin-right: 40px;height: 33px; overflow: hidden; font-size: initial;\"> welcome  ".  $_SESSION['user_info'] ['name']. "</pre>";
